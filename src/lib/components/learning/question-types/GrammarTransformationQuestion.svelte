<script lang="ts">
	...
	const instructionText = $derived(i18n.locale === 'de' ? instructionDe : instructionEn);
...
<div class="card">
	<h2 class="mb-2 text-lg font-bold text-text-light">
		{t('lesson.types.grammarTransformation') || 'Grammar Transformation'}
	</h2>
	...
	<div class="mb-6">
		...
		<div class="rounded-xl border border-border-light bg-bg-light-secondary p-4">
			<p class="mb-1 font-medium text-primary">{t('lesson.instruction') || 'Instruction'}:</p>
