...
export const GRAMMAR_A1: GrammarPointData[] = [
	{
		...
		explanationDe:
			'Mit ser druckt man Identitat, Herkunft, Beruf und andere dauerhafte Eigenschaften aus. Es beantwortet, was jemand oder etwas seinem Wesen nach ist. Typische Hinweise sind Namen, Nationalitaten und Berufe.',
	...
	},
	{
		...
		explanationDe:
			'Mit estar druckt man vorubergehende Zustande und Orte aus. Es beschreibt oft, wie sich jemand gerade fuhlt oder wo sich Personen und Dinge befinden. Viele Adjektive andern ihre Bedeutung je nach ser oder estar.',
		pattern: 'yo estoy, tu estas, el/ella esta, nosotros estamos, vosotros estais, ellos estan',
		examples: [
			{ target: 'Estoy cansado.', en: 'I am tired.', de: 'Ich bin mude.' },
			{
	...
	},
	{
		...
		titleDe: 'Regelmassige -ar-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Regelmassige -ar-Verben verlieren im Prasens die Endung -ar und bekommen feste Endungen. Dieses Muster ist sehr haufig und hilft beim Aufbau vieler einfacher Satze. Typische Verben sind hablar und caminar.',
	...
	},
	{
		...
		titleDe: 'Regelmassige -er-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Regelmassige -er-Verben nutzen nach Wegfall von -er feste Prasensendungen. Dieses Muster sollte man fruh lernen, weil es viele Alltagsverben abdeckt. Typische Beispiele sind comer und beber.',
	...
	},
	{
		...
		titleDe: 'Regelmassige -ir-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Regelmassige -ir-Verben haben Endungen ahnlich wie -er-Verben, aber mit nosotros und vosotros in -imos und -is. Diese Gruppe ist im Alltag sehr verbreitet. Beispiele sind vivir und escribir.',
		...
		examples: [
			...
			{ target: 'Ellos abren la puerta.', en: 'They open the door.', de: 'Sie offnen die Tur.' }
		],
		cefrLevel: 'A1',
		order: 5
	},
	{
		...
		explanationDe:
			'Bestimmte Artikel beziehen sich auf konkrete Nomen und mussen in Genus und Numerus ubereinstimmen. Man verwendet el/la im Singular und los/las im Plural. Das Nomen bestimmt den passenden Artikel.',
		pattern: 'el libro, la casa, los libros, las casas',
		examples: [
			{ target: 'El coche es nuevo.', en: 'The car is new.', de: 'Das Auto ist neu.' },
			{ target: 'La mesa es grande.', en: 'The table is big.', de: 'Der Tisch ist gross.' },
			{
				target: 'Las flores son bonitas.',
				en: 'The flowers are pretty.',
				de: 'Die Blumen sind schon.'
			}
		],
		cefrLevel: 'A1',
		order: 6
	},
	{
		...
		explanationDe:
			'Unbestimmte Artikel fuhren nicht naher bestimmte Nomen ein. Sie passen sich ebenfalls an Genus und Numerus an: un/una im Singular, unos/unas im Plural. Im Deutschen entsprechen sie ein/eine bzw. einige.',
		...
		examples: [
			...
			{ target: 'Ella compra una falda.', en: 'She buys a skirt.', de: 'Sie kauft einen Rock.' },
			{
				...
				de: 'Wir brauchen ein paar Stuhle.'
			}
		],
		cefrLevel: 'A1',
		order: 7
	},
	{
		...
		explanationDe:
			'Adjektive stimmen im Spanischen meist in Genus und Numerus mit dem Nomen uberein. Viele Adjektive auf -o werden zu -a, -os oder -as. Diese Kongruenz ist fur korrektes Spanisch zentral.',
		pattern: 'chico alto, chica alta, chicos altos, chicas altas',
		examples: [
			{ target: 'La casa blanca', en: 'The white house', de: 'Das weisse Haus' },
	...
	},
	{
		...
		explanationDe:
			'Die einfache Verneinung bildet man mit no direkt vor dem konjugierten Verb. Das ist das Grundmuster fur nicht in einfachen Satzen. No steht dabei unmittelbar beim Verb.',
	...
	},
	{
		...
		explanationDe:
			'Spanische Frageworter leiten Erganzungsfragen ein und tragen in der Regel Akzente. Zentrale Formen sind que, donde, cuando, como, cuanto und quien. Damit fragt man gezielt nach Informationen.',
	...
	},
	{
		...
		explanationDe:
			'Hay ist eine unpersonliche Form im Sinn von es gibt. Sie bleibt im Singular und Plural gleich. Man verwendet sie, um die Existenz von Dingen oder Personen auszudrucken, oft mit unbestimmtem Artikel.',
		pattern: 'hay + noun',
		examples: [
			{
	...
	},
	{
		...
		explanationDe:
			'Gustar hat eine umgekehrte Struktur: Das, was gefallt, ist das grammatische Subjekt. Dazu kommt meist ein indirektes Objektpronomen wie me, te oder le. Man verwendet gusta bei Singular und Verben, gustan bei Plural.',
		pattern: 'me/te/le/nos/os/les + gusta(n) + noun/infinitive',
		examples: [
			{ target: 'Me gusta la musica.', en: 'I like music.', de: 'Ich mag Musik.' },
			{ target: 'Te gustan los libros.', en: 'You like books.', de: 'Du magst Bucher.' },
	...
	},
	{
		...
		explanationDe:
			'Tener bedeutet haben und ist in der yo-Form unregelmassig (tengo). Es steht ausserdem in vielen festen Ausdrucken, etwa fur Alter und Befinden. Deshalb gehort es zu den wichtigsten Verben im Alltag.',
	...
	},
	{
		...
		explanationDe:
			'Ir bedeutet gehen/fahren und hat vollig unregelmassige Prasensformen. Es ist zentral fur Bewegung und nahe Zukunft mit ir + a + Infinitiv. Fur A1 sollte man alle Formen sicher beherrschen.',
