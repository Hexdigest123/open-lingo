...
export const GRAMMAR_A1: GrammarPointData[] = [
	{
		...
		explanationDe:
			'Essere bedeutet sein und wird fur Identitat, Herkunft und Eigenschaften verwendet. Das Verb ist stark unregelmassig, daher sollte man die Formen fruh auswendig lernen. Es gehort zu den haufigsten Verben im Italienischen.',
		...
		examples: [
			...
			{ target: 'Lei e stanca.', en: 'She is tired.', de: 'Sie ist mude.' },
	...
	},
	{
		...
		explanationDe:
			'Avere bedeutet haben und kommt bei Besitz, Alter und vielen festen Wendungen vor. Ausserdem dient es oft als Hilfsverb fur Vergangenheitsformen. Deshalb ist es von Anfang an zentral.',
		pattern: 'io ho, tu hai, lui/lei ha, noi abbiamo, voi avete, loro hanno',
		examples: [
			{ target: 'Ho due fratelli.', en: 'I have two brothers.', de: 'Ich habe zwei Bruder.' },
			{
	...
	},
	{
		...
		titleDe: 'Regelmassige -are-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Regelmassige -are-Verben verlieren -are und bekommen feste Prasensendungen. Dieses Muster deckt viele Alltagsverben ab. Typische Beispiele sind parlare und mangiare.',
	...
	},
	{
		...
		titleDe: 'Regelmassige -ere-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Regelmassige -ere-Verben folgen nach dem Wegfall von -ere einem festen Prasensmuster. Sie kommen in der Grundkommunikation sehr haufig vor. Beispiele sind scrivere und leggere.',
	...
	},
	{
		...
		titleDe: 'Regelmassige -ire-Verben (Prasens)',
		explanationEn:
		...
		explanationDe:
			'Grundlegende -ire-Verben verwenden regelmassige Endungen und sind fur Alltagshandlungen wichtig. Auf A1 konzentriert man sich auf klare Kernverben wie dormire und partire. Andere -ire-Verben zeigen spater ein zusatzliches -isc--Muster.',
	...
	},
	{
		...
		explanationDe:
			'Bestimmte Artikel im Italienischen hangen von Genus, Numerus und dem Anlaut des folgenden Nomens ab. Im Singular stehen il/lo/la, im Plural i/gli/le. Die richtige Form ist grundlegend fur korrekte Nominalgruppen.',
		pattern: 'il libro, lo studente, la casa, i libri, gli studenti, le case',
		examples: [
			{ target: 'Il ragazzo e alto.', en: 'The boy is tall.', de: 'Der Junge ist gross.' },
	...
	},
	{
		...
		explanationDe:
			'Unbestimmte Artikel fuhren nicht naher bestimmte Nomen im Singular ein. Die Form richtet sich nach Genus und Anlaut: un, uno oder una. Im Deutschen entsprechen sie ein bzw. eine.',
	...
	},
	{
		...
		explanationDe:
			'Italienische Adjektive stimmen in Genus und Numerus mit dem Nomen uberein. Haufige Endungen sind -o/-a im Singular und -i/-e im Plural. Diese Ubereinstimmung ist fur korrektes Italienisch notwendig.',
		pattern: 'ragazzo alto, ragazza alta, ragazzi alti, ragazze alte',
		examples: [
			{ target: 'Una casa grande', en: 'A big house', de: 'Ein grosses Haus' },
			{ target: 'I libri nuovi', en: 'The new books', de: 'Die neuen Bucher' },
			{ target: 'Le strade lunghe', en: 'The long streets', de: 'Die langen Strassen' }
		],
		cefrLevel: 'A1',
		order: 8
	},
	{
		...
		explanationDe:
			'Die einfache Verneinung im Italienischen verwendet non vor dem konjugierten Verb. Das ist das Grundmuster fur nicht in einfachen Aussagesatzen. Non steht dabei direkt vor dem Verb.',
	...
	},
	{
		...
		explanationDe:
			'Mit Fragewortern fragt man im Italienischen gezielt nach Informationen. Zentrale Formen sind che, dove, quando, come, quanto und chi. Sie sind fur Alltagsgesprache unverzichtbar.',
	...
	},
	{
		...
		explanationDe:
			"C'e bedeutet es gibt (Singular), ci sono bedeutet es gibt (Plural). Mit diesen Formen druckt man Existenz und Vorhandensein aus. Sie gehoren zu den nutzlichsten Strukturen auf Anfangerniveau.",
	...
	},
	{
		...
		explanationDe:
			'Piacere funktioniert wie gustar im Spanischen: Das, was gefallt, ist grammatisches Subjekt. Dazu verwendet man Objektpronomen wie mi, ti, gli, ci, vi oder loro. Piace steht bei Singular und Verben, piacciono bei Plural.',
		pattern: 'mi/ti/gli/ci/vi/loro + piace/piacciono + noun/infinitive',
		examples: [
			{ target: 'Mi piace la musica.', en: 'I like music.', de: 'Ich mag Musik.' },
			{ target: 'Ti piacciono i libri.', en: 'You like books.', de: 'Du magst Bucher.' },
	...
	},
	{
		...
		explanationDe:
			'Possessivformen wie mio, tuo, suo, nostro und vostro richten sich nach dem Bezugsnomen. Im Italienischen stehen sie oft zusammen mit einem Artikel. Sie sind wichtig fur Familie und Besitzangaben.',
	...
	},
	{
		...
		explanationDe:
			'Andare bedeutet gehen/fahren und ist im Prasens unregelmassig. Es wird fur Bewegung und Ziele mit a + Ort verwendet. Dieses Verb ist im Alltag unverzichtbar.',
	...
	},
	{
		...
		explanationDe:
			'Fare bedeutet tun oder machen und ist im Prasens unregelmassig. Es erscheint in vielen alltaglichen Wendungen wie fare colazione oder fare sport. Fur naturliche Kommunikation braucht man es sehr fruh.',
