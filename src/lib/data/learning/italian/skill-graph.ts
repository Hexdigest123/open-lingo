...
export const ITALIAN_SKILL_GRAPH: SkillGraphDefinition = {
	skills: [
		...
		},
		{
			...
			descriptionDe: 'Grundlegende Begrüßungen und höfliche Wendungen auf Italienisch.',
			cefrLevel: 'A1',
			iconName: 'handshake',
			order: 2,
		...
		},
		{
			...
			descriptionDe: 'Wichtige Zahlen für Zahlenangaben und den Alltag.',
			cefrLevel: 'A1',
			iconName: 'hash',
			order: 3,
		...
		},
		{
			...
			descriptionDe: 'Zentrale unregelmäßige Verben für sein und haben.',
			cefrLevel: 'A1',
			iconName: 'split',
			order: 5,
		...
		},
		{
			...
			descriptionDe: 'Präsensendungen für regelmäßige -are-, -ere- und -ire-Verben.',
			cefrLevel: 'A1',
			iconName: 'repeat',
			order: 6,
		...
		},
		{
			...
			descriptionDe: 'Fragewörter für Personen, Orte und Zeitangaben.',
			cefrLevel: 'A1',
		...
		},
		{
			...
			descriptionDe: 'Wortschatz für nahe Familienmitglieder.',
			cefrLevel: 'A1',
			iconName: 'users',
			order: 9,
		...
		},
		{
			...
			descriptionDe: 'Grundwortschatz für Essen und Trinken im Alltag.',
			cefrLevel: 'A1',
			iconName: 'utensils',
			order: 10,
		...
		},
		{
			...
			descriptionDe: 'Übereinstimmung von Adjektivendungen in Genus und Numerus.',
			cefrLevel: 'A1',
			iconName: 'align-left',
			order: 11,
		...
		},
		{
			...
			descriptionDe: 'Unregelmäßige Präsensformen für Bewegung und Alltagshandlungen.',
			cefrLevel: 'A1',
			iconName: 'navigation',
			order: 13,
		...
		},
		{
			...
			descriptionDe: 'Vergangenheit für Hintergründe, Gewohnheiten und andauernde Zustände.',
			cefrLevel: 'A2',
			iconName: 'clock-3',
			order: 15,
