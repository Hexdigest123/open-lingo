...
<svelte:head>
	<title>{m["admin.approvals.title"]()} - OpenLingo Admin</title>
</svelte:head>

<div class="space-y-6">
	<div class="flex items-center justify-between">
		<h1 class="text-2xl font-bold text-text-light">{m["admin.approvals.title"]()}</h1>
	...
	<div class="card">
		<h2 class="mb-4 text-lg font-semibold text-text-light">{m["admin.approvals.pendingTitle"]()}</h2>
		{#if data.pendingUsers.length === 0}
	...
	<div class="card">
		<h2 class="mb-4 text-lg font-semibold text-text-light">{m["admin.approvals.declinedTitle"]()}</h2>
		{#if data.rejectedUsers.length === 0}
			<div class="py-8 text-center">
				<div
